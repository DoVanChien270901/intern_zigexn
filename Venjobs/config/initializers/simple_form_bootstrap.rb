...
SimpleForm.setup do |config|
  ...
  # vertical file input
  config.wrappers :vertical_file, tag: 'div', class: 'form-group mb-3', error_class: 'form-group-invalid',
                                  valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
  ...
  # custom input select
  config.wrappers :my_select, tag: 'div', class: 'form-group mb-3', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: 'form-label'
...
# my input date
  config.wrappers :my_date, tag: 'div', class: 'form-group date col mb-3', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: 'form-label'
    b.use :input, class: 'form-control', error_class: 'is-invalid', valid_class: 'is-valid'
